...
class Request(BaseRequest):
    ...
    def get_response(self):
        ...
        if self.method in ('DELETE', 'GET'):
            ...
            body = urllib.parse.urlencode(self.POST.copy())
    ...
    def set_url(self, url):
        ...
        if url.startswith("http://") or url.startswith("https://"):
            ...
            url = urllib.parse.urlunsplit((u.scheme, u.netloc.split("@")[-1], 
            ...
            url = self.url
        self.scheme, self.host, self.path_info = urllib.parse.urlparse(url)[0:3]
